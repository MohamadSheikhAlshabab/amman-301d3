...
let Student = function(name, age, hometown) {this.name = name;this.age = age;this.hometown = hometown;};
...
// this refers to the values of this in the environment the arrow function is defined inside it
